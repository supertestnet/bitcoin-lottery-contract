...
- Detect unexpected delays and warn users that there is a possible cheating attempt and what will happen next (e.g. they might need to wait up to 16 blocks but they are guaranteed to either win or lose fairly if they wait that long)
